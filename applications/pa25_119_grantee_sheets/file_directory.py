...
pa25_119_file_directory = {
    'ACI Healthcare': {
        "pa25_119 data": {
            "PY4 Q2":{ 
                "file path": rf"{DATA_DIR}\Datasets for Validation\PA25_119_Test\ACI Healthcare.xlsx",
    ...
    'ACI Manufacturing': {
        "pa25_119 data": {
            "PY4 Q2":{ 
                "file path": rf"{DATA_DIR}\Datasets for Validation\PA25_119_Test\ACI Manufacturing.xlsx",
                "format": "simple format"
            }
        }   
    },
    'ACJ WIOA': {
        "pa25_119 data": {
            "PY4 Q2":{ 
                "file path": rf"{DATA_DIR}\Datasets for Validation\PA25_119_Test\ACJ WIOA.xlsx",
                "format": "simple format"
            }
        }
    },
    'BestChance, JobsFunnel, WE RISE, CDS': {
        "pa25_119 data": {
            "PY4 Q2":{ 
                "file path": rf"{DATA_DIR}\Datasets for Validation\PA25_119_Test\BestChance, JobsFunnel, WE RISE, CDS.xlsx",
                "format": "simple format"
            }
        }
    },
    'CCCT': {
        "pa25_119 data": {
            "PY4 Q2":{ 
                "file path": rf"{DATA_DIR}\Datasets for Validation\PA25_119_Test\CCCT.xlsx",
                "format": "simple format"
            }
        }
    }
