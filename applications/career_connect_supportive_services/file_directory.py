...
file_directory = {
  "Marrakech": {
    "cc_supportive_services": {
      ...
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Marrakech" / "PY4 Q2" / "CCT Supportive Services 10.1.25-12.31.25.xlsx",
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "Career Resources We Rise": {
    "cc_supportive_services": {
      ...
      "PY3 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Career Resources WeRise" / "PY3 Q4" / "Career_Resources_We_Rise_WERISE_Y3Q4__Data_Spreadsheet.xlsx",
        "format": "simple format"
      },
      "PY4 Q1": {
      ...
      "PY4 Q2": {
        ## this is currently missing transfers, need to talk to Dave about how he formats these.  
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Career Resources WeRise" / "Y4Q2" / "CRI We Rise. Y4Q2. Universal CareerConneCT Supportive Services Workbook.xlsx",
        "format": "simple format"
      }
    }
  ...
  "Career Resources Health Career": {
    "cc_supportive_services": {
      ...
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Career Resources Health Career Training Program" / "Y4Q2" / "Y4 Q2 CRI Healthcare Careers. Universal Supportive Services Workbook.xlsx",
        "format": "simple format"
      }
    }
  },
  "CWP": {
    "cc_supportive_services": {
      ...
      "PY3 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Capital Workforce Partners" / "Capital Workforce Partners CDL" / "PY3 Q4" / "CWP_CDL_PY3Q4_CWP_CDL_Data_2025710.xlsx",
        "format": "simple format"
      },
      "PY4 Q1": {
      ...
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Capital Workforce Partners" / "Capital Workforce Partners CDL" / "Y4Q2" / "CWP CCT Support Services_20260108.xlsx",
        "format": "simple format"
      }
    }
  },
  "EWIB": {
    "cc_supportive_services": {
      ...
      "PY3 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Eastern Workforce Investment Board" / "PY3 Q4" / "EWIB_Y3Q4_Data_Entry_Spreadsheet.xlsx",
        "format": "simple format"
      },
      "PY4 Q1": {
      ...
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Eastern Workforce Investment Board" / "Y4Q2" / "12-31-25 EWIB Manufacturing CareerConneCT Supportive Services Workbook.xlsx",
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "TWP Health CareeRx Academy": {
    "cc_supportive_services": {
      ...
      "PY4 Q2": {
        "file path": [FILE_DIRECTORY_ROOT / "Career Connect" / "TWP Health CareeRx" / "Y4Q2" / "Y4Q1 Universal CareerConneCT Supportive Services Workbook Part 1.xlsx",
                      FILE_DIRECTORY_ROOT / "Career Connect" / "TWP Health CareeRx" / "Y4Q2" / "Y4Q1 Universal CareerConneCT Supportive Services Workbook Part 2 (2).xlsx"],
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "TWP Remote Works": {
    "cc_supportive_services": {
      ...
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "TWP Remote Works" / "Y4Q2" / "RemoteWorks Universal CareerConneCT Supportive Services Workbook Y4 Q2.xlsx",
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "Charter Oak State College Foundation": {
    "cc_supportive_services": {
      ...
      "PY2 Q3": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Charter Oak State College Foundation" / "PY2 Q3" / "CareerConneCT .xlsx",
        "format": "simple format"
      },
      "PY2 Q4": {
      ...
      "PY3 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Charter Oak State College Foundation" / "Y3Q4" / "Charter_Oak_State_College_Foundation_Y3Q4_COSCF_Data_Entry_Spreadsheet.xlsx",
        "format": "simple format"
      },
      "PY4 Q1": {
      ...
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Charter Oak State College Foundation" / "Y4Q2" / "CareerConneCT Supportive Services Workbook Charter Oak State College Foundation December2025FINAL.xlsx",
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "Connecticut State Building Trades Training Institute": {
    "cc_supportive_services": {
      "PY2 Q1": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Connecticut State Buildings Trade Training Institute" / "PY2 Q1" / "2023-10-10_CSBTTI_Participants.xlsx",
        "format": "simple format"
      },
      "PY2 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Connecticut State Buildings Trade Training Institute" / "PY2 Q2" / "CareerConneCT Staggered Data Entry Spreadsheet.xlsx",
        "format": "simple format"
      },
      "PY2 Q3": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Connecticut State Buildings Trade Training Institute" / "PY2 Q3" / "CareerConneCT Staggered Data Entry Spreadsheet  as of  33124 FINAL (1).xlsx",
        "format": "simple format"
      },
      "PY2 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Connecticut State Buildings Trade Training Institute" / "PY2 Q4" / "CareerConneCT Staggered Data Entry Spreadsheet 63024 FINAL.xlsx",
        "format": "simple format"
      },
      "PY3 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Connecticut State Buildings Trade Training Institute" / "PY3Q2" / "Y3Q2 CCT Staggered Spreadsheet CSBTTI.xlsx",
        "format": "simple format"
      },
      "PY3 Q3": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Connecticut State Buildings Trade Training Institute" / "Y3Q3" / "CareerConneCT Staggered Data Entry Spreadsheet 33125.xlsx",
        "format": "simple format"
      },
      "PY3 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Connecticut State Buildings Trade Training Institute" / "Y3Q4" / "Connecticut_State_Building_Trades_Training_Institute_Y3Q4_CSBTTI_Data_Entry_Spreadsheet.xlsx",
        "format": "simple format"
      },
      "PY4 Q1": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Connecticut State Buildings Trade Training Institute" / "Y4Q1" / "Connecticut_State_Building_Trades_Training_Institute_Y4Q1.xlsx",
        "format": "simple format"
      },
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Connecticut State Buildings Trade Training Institute" / "Y4Q2" / "CSBTTI SuppServ Combined FINAL SBB _OWS December 2025 .xlsx",
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "Family Centers": {
    "cc_supportive_services": {
      ...
      "PY3 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Family Centers" / "PY3Q2" / "CCTStaggeredSpreadsheetY3Q2FC.xlsx",
        "format": "simple format"
      },
      "PY3 Q3": {
      ...
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Family Centers" / "Y4Q2" / "Universal CareerConneCT Supportive Services Workbook Y4Q2.xlsx",
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "Havenly": {
    "cc_supportive_services": {
      ...
      "PY3 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Havenly" / "Y3Q4" / "Havenly - CareerConneCT Staggered Data Entry Spreadsheet Y3Q4.xlsx",
        "format": "simple format"
      },
      "PY4 Q1": {
      ...
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Havenly" / "Y4Q2" / "CareerConneCT Supportive Services Workbook Y4Q2.xlsx",
        "format": "simple format",
        "starting row": 1
      }
  ...
  "ReadyCT": {
    "cc_supportive_services": {
      ...
      "PY4 Q2": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "ReadyCT" / "Y4Q2" / "ReadyCT CareerConneCT Supportive Services Workbook 01_09_2026.xlsx",
        "format": "simple format"
      }
    }
  },
  "CCAT": {
    "cc_supportive_services": {
      ...
      "PY3 Q3": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "CCAT" / "Y3Q3" / "Y3Q3 Supportive Ser Wkbk CCAT.xlsx",
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "Efficiency For All": {
    "cc_supportive_services": {
      ...
      "PY2 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Efficiency for All" / "PY2 Q4" / "2024-06-30 EFA Supportive Services FY2 Q4 (Q8).xlsx",
        "format": "simple format",
        "starting row": 1
      },
  ...
  "DAE": {
    "cc_supportive_services": {
      ...
      "PY3 Q3": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "District Arts and Education" / "PY3 Q3" / "DAE_Y3Q3_Data_Entry_Spreadsheet_DAE.xlsx",
        "format": "simple format"
      },
      "PY3 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "District Arts and Education" / "PY3 Q4" / "Contract 22GOV0012AA_DAE_Supportive Services Workbook_July 2025_final (1).xlsx",
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "ConnCat": {
    "cc_supportive_services": {
      ...
      "PY3 Q3": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "ConnCAT" / "PY3 Q3" / "Y3Q3 Data Entry Spreadsheet ConnCAT.xlsx",
        "format": "simple format"
      },
      "PY3 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "ConnCAT" / "Y3 Q4 FINAL" / "ConnCAT_PY3Q4_SS_submitted.xlsx",
        "format": "simple format"
      }
    }
  },
  "Ability Beyond": {   
    "cc_supportive_services": {
      ...
      "PY3 Q1": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Ability Beyond" / "PY3_Q1" / "Staggered Data Entry Spreadsheet_10.10.24.xlsx",
        "format": "simple format"
      },
      "PY3 Q2": {
      ...
      "PY3 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Ability Beyond" / "Y3Q4 Final" / "CCT Sup Ser Wkbk as of 9.9.25.xlsx",
        "format": "simple format",
        "starting row": 1
      }
    }
  ...
  "NRWIB": {
      "cc_supportive_services": {
      "PY3 Q4": {
          "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "NRWIB" / "Y3Q4" / "Supportive Services Workbook P3 Q4-updated 9-3.xlsx",
          "format": "simple format"
      }
  }
