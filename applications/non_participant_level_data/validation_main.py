...
from applications.non_participant_level_data.workbook_definitions import workbook_definitions
from applications.non_participant_level_data.file_directory import file_directory
from applications.non_participant_level_data.cross_rule_sets import CONNECTED_PRESENCE_RULES, CONDITIONALLY_BLANK_UNLESS_RULES, CONDITIONALLY_ALLOWED_RULES, CONDITIONALLY_REQUIRED_RULES , CONDITIONALLY_REQUIRED_BY_DATE_COMPARISON_RULES
...
TARGET_ORGS = None
TARGET_PERIODS = ["PY2 Q3", "PY2 Q4", "PY3 Q1", "PY3 Q2", "PY3 Q3", "PY3 Q4", "PY4 Q1","PY4 Q2"]
...
for target_period in periods_to_run:    
    ...
    for org, data_types in file_directory.items():
        ...
        engine = ValidationEngine(workbook_definitions, logging = LOGGING, log_description=LOG_DESCRIPTION)
    ...
    output_file = OUTPUT_DIRECTORY / f"{file_type}_npld_validation_results_all_orgs_{target_period}.xlsx"
