...
file_directory = {
  ...
  "Efficiency For All": {
    "training data": {
      ...
      "PY2 Q4": {
        "file path": FILE_DIRECTORY_ROOT / "Career Connect" / "Efficiency for All" / "PY2 Q4" / "Efficiency_For_All_EFA_Expanded_Staggered_Data_Entry_Spreadsheet_Current_2024-06-30.xlsx",
        "format": "four sheet format"
      }
    }
  },
