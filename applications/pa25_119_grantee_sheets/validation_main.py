...
from applications.pa25_119_grantee_sheets.file_directory import pa25_119_file_directory
...
for org, data_types in pa25_119_file_directory.items():
...
output_file = rf"{DATA_DIR}\PA25-119\.Programmatic_Data\Cleaned Programmatic Data\pa25_119_validation_results_all_orgs_{target_period}.xlsx"
