...
RACE_ETHNICITY_MAPPING = {
    ...
    "Race, White": ["White", "Caucasian or White", "Blanc", "215"],
    "Race, Asian": ["Asian", "212"],
    "Race, American Indian or Alaska Native": ["American Indian or Alaska Native", "American Indian", "211"],
    "Race, Hawaiian/Pacific Islander": ["Native Hawaiian or Other Pacific Islander", "214"],
    "Race, Multi-Racial": ["Multi-racial"],
    "Race, Other": ["Other", "Prefer to self-identify"],
    "Race, Unknown": ["Prefer not to answer", "DID NOT DISCLOSE", "Choose not to answer", "", None],
    "Ethnicity, Hispanic or Latino": [
        "Hispanic or Latino","Hispanic", "Latino", "or Spanish", "Hispanic, Latino, or Spanish",
